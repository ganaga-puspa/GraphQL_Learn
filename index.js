...
const products = [
  {
    ...
    image: "img-1",
    onSale: false,
    catgoryID: "c01b1ff4-f894-4ef2-b27a-22aacc2fca70",
  },
  {
  ...
  },
  {
    ...
    image: "img-4",
    onSale: false,
    catgoryID: "34115aac-0ff5-4859-8f43-10e8db23602b",
  },
  {
  ...
  },
  {
    ...
    image: "img-6",
    onSale: true,
    catgoryID: "d914aec0-25b2-4103-9ed8-225d39018d1d",
  },
  {
...
const resolvers = {
  ...
  Category: {
    products: (parent, args, context) => {
      ...
      return products.filter((prod) => prod.catgoryID === categoryId);
    },
  },
};
...
server.listen().then(({ url }) => {
  console.log("Ganaga Server is ready" + url);
});
